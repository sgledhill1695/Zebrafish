...
if (isset($_POST['submit'])){
     ...
     if(!empty($_POST['surgery_contract'])){
        $contract_expiry = $_POST['surgery_contract'];
     } else {
        $contract_expiry = "No expiry date given";
     }
     
     $subject = "Zebrafish New Order";
     $customer_subject = "We've got your submission!";
